    ...
    return (
        <div className="w-[350px] p-2 border-[3px] border-black border-solid">
            ...
            <form className="flex flex-col items-center w-80 mx-auto my-4">
                ...
                <input type="number" className="w-full p-2 mb-2 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder="მოსწავლის პირადი ნომერი" value={studentId} onChange={e => setStudentId(Number(e.target.value))}/>
